export function VideoCommentsFallback() {
  return (
    <>
      <div className="mb-4">
        <div className="bg-secondary/60 h-6 w-24 animate-pulse rounded" />
      </div>

      <div className="flex gap-3 pb-6">
        <div className="bg-secondary/70 h-10 w-10 flex-shrink-0 animate-pulse rounded-full" />
        <div className="flex-1">
          <div className="bg-secondary/60 h-10 animate-pulse rounded" />
        </div>
      </div>
